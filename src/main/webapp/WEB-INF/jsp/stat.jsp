                ...
                <form action="#">
                    <div class="row">
                        <div class="alert alert-danger" id="alrt-invalid-period" hidden="">
                            <strong>Invalid Date Period! : </strong><div id="alrt-ip-msg"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6"><b>Begin  from : </b><input type="date" name="bDate" id="input-b-date" class="form-control"/></div>
                        <div class="col-sm-6"><b>To </b><input type="date" name="bDate" id="input-e-date" class="form-control"/></div>
                    </div>
