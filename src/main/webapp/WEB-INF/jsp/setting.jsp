        ...
        <div id="spec-location-section">
            <div class="container">
                ...
                <div class="row well">
                    ...
                    <div class="col-sm-4">
                        <fieldset>
                            <input type="hidden" placeholder="Enter Somewhere (ex. สถานีรถไฟหัวลำโพง)" id="spec-location-input" placeholder="Enter the place" class="form-control"/>
                            <hr/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3"><input type="button" id="update-location-submit" value="Update" class="btn btn-primary" style="width: 100%"/><br/><br/></div>
